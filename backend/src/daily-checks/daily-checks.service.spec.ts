...
describe('DailyChecksService', () => {
  ...
  let repository: Repository<DailyCheck>;
  ...
  beforeEach(async () => {
    ...
    repository = module.get<Repository<DailyCheck>>(getRepositoryToken(DailyCheck));
  });
  ...
  describe('updateResponse', () => {
    ...
    it('should throw error if daily check not found', async () => {
      ...
      await expect(service.updateResponse(999, 'clean'))
        .rejects.toThrow('Daily check not found');
    });
  });
